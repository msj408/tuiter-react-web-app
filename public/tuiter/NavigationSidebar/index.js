const NavigationSidebar = (active) => {
    return(`<div class="list-group">
     ...
     <a href="../exploreScreen/index.html" class="list-group-item bg-primary text-white"><i class="fa-solid fa-hashtag"></i>  <span class="d-none d-xl-inline"> Explore</span></a>
